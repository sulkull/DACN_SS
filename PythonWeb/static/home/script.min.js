...
function set_filter2(e, t, n, l, i) {
    "" == l && (l = "0"), "" == e && (e = "0"), "" == n && (n = "0"), "" == t && (t = "0"), "" == i && (i = "0"), html = "", "0" != l && (document.getElementById("lF0").className = "all", document.getElementById("lF" + l.replace(",", "")).className = "check", html += '<a href="javascript:;" onclick="lengthFilter(0)">' + document.getElementById("lF" + l.replace(",", "")).textContent + ' <i class="ic-clearfil"></i></a>'), "0" != e && (document.getElementById("pF0").className = "all", document.getElementById("pF" + e.replace(",", "")).className = "check", html += '<a href="javascript:;" onclick="priceFilter(0)">' + document.getElementById("pF" + e.replace(",", "")).textContent + ' <i class="ic-clearfil"></i></a>'), "0" != t && (document.getElementById("tF0").className = "all", document.getElementById("tF" + t.replace(",", "")).className = "check", html += '<a href="javascript:;" onclick="telcoFilter(0)">' + document.getElementById("tF" + t.replace(",", "")).textContent + ' <i class="ic-clearfil"></i></a>'), "0" != n && (document.getElementById("sF0").className = "all", document.getElementById("sF" + n.replace(",", "")).className = "check", html += '<a href="javascript:;" onclick="sortFilter(0)">' + document.getElementById("sF" + n.replace(",", "")).textContent + ' <i class="ic-clearfil"></i></a>'), "1" == i && (document.getElementById("active-tragop").className = "ic-checkbox-active"), document.getElementById("choosedfilter").insertAdjacentHTML("beforebegin", html), document.getElementById("m10so_filter").value = l, document.getElementById("price_filter").value = e, document.getElementById("telco_filter").value = t, document.getElementById("giaban_filter").value = n, document.getElementById("tragop_filter").value = i
}
...
function simple_search2(e) {
    return "" == (e = (e = (e = (e = new String(e)).toLowerCase()).replace(/[^0-9^*^x]/g, "")).replace(/\*+/g, "*")) ? (alert("Nhập số cần tìm có ít nhất 2 chữ số!"), document.timkiem2.tag2.focus(), !1) : (document.getElementById("loading_div").style.display = "block", location.href = "https://simthanglong.vn/tim-sim/" + e + ".html", !0)
}
