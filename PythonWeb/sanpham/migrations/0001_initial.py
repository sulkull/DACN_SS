    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(default='', max_length=20)),
                ('TacVu', models.CharField(choices=[('thuong', 'Sim Thường'), ('khuyenmai', 'Sim Khuyến Mãi'), ('vip', 'Sim Vip'), ('vipdn', 'Sim Vip Doanh Nhân')], default='thuong', max_length=100, verbose_name='Tác vụ trang chủ')),
                ...
                ('Anh', models.ImageField(null=True, upload_to='', verbose_name='Hình đại diện')),
                ...
                ('NamSinh', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sanpham.SimNamSinh', verbose_name='Theo năm sinh ')),
            ],
            options={
